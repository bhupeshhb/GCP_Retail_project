CREATE EXTERNAL TABLE IF NOT EXISTS `retail-data-lake.bronze_dataset.orders`(
    order_id INT64,
    customer_id INT64,
    order_date STRING,
...
OPTIONS (
  format = 'JSON',
  uris = ['gs://datalake-project-bkt-30032025/landing/supplier-db/product_suppliers/*.json']
);
...
OPTIONS (
  format = 'PARQUET',
  uris = ['gs://datalake-project-bkt-30032025/landing/customer_reviews/customer_reviews_*.parquet']
);
